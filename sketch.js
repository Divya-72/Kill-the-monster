...
function setup() {
  ...
  box8=new Box(600,380,70,70);
  box9=new Box(600,450,70,70);
  box10=new Box(600,520,70,70);

//row2
box11=new Box(700,100,70,70);
box12=new Box(700,170,70,70);
box13=new Box(700,240,70,70);
box14=new Box(700,310,70,70);
box15=new Box(700,380,70,70);
box16=new Box(700,450,70,70);
